...
impl ScreenshotManager {
    ...
    pub async fn capture_viewport(&self, _tab_id: &str, options: &ScreenshotOptions) -> Result<ScreenshotResult> {
    ...
    pub async fn capture_full_page(&self, _tab_id: &str, options: &ScreenshotOptions) -> Result<ScreenshotResult> {
    ...
    pub async fn capture_element(&self, _tab_id: &str, _selector: &str, options: &ScreenshotOptions) -> Result<ScreenshotResult> {
